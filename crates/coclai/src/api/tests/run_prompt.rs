...
async fn run_prompt_applies_pre_mutations_for_prompt_model_attachment_and_metadata() {
    ...
    let patches = vec![
        (
            HookPhase::PreRun,
            crate::plugin_core_contract::HookPatch {
                prompt_override: Some("patched-in-pre-run".to_owned()),
                model_override: Some("model-pre-run".to_owned()),
                add_attachments: vec![crate::plugin_core_contract::HookAttachment::ImageUrl {
        ...
        (
            ...
            crate::plugin_core_contract::HookPatch {
                ...
                add_attachments: vec![crate::plugin_core_contract::HookAttachment::Skill {
                    name: "probe".to_owned(),
...
async fn run_prompt_ignores_invalid_hook_attachment_with_fail_open() {
    let patches = vec![(
        ...
        crate::plugin_core_contract::HookPatch {
            ...
            model_override: None,
            add_attachments: vec![crate::plugin_core_contract::HookAttachment::LocalImage {
