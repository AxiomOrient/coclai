...
pub fn reduce_in_place_with_limits(
    ...
    match method {
        "thread/started" => handle_thread_started(state, envelope, seq),
        "turn/started" => handle_turn_started(state, envelope, seq),
        "turn/completed" => {
            handle_turn_terminal(state, envelope, seq, TurnStatus::Completed, false)
        }
        "turn/failed" => handle_turn_terminal(state, envelope, seq, TurnStatus::Failed, true),
        "turn/interrupted" => {
            handle_turn_terminal(state, envelope, seq, TurnStatus::Interrupted, false)
        }
        "turn/diff/updated" => handle_turn_diff_updated(state, envelope, seq),
        "turn/plan/updated" => handle_turn_plan_updated(state, envelope, seq),
        "item/started" => handle_item_started(state, envelope, seq),
        "item/agentMessage/delta" => handle_item_agent_message_delta(state, envelope, seq, limits),
        "item/commandExecution/outputDelta" => {
            handle_item_command_output_delta(state, envelope, seq, limits)
        }
        "item/completed" => handle_item_completed(state, envelope, seq),
        _ => {}
    }
